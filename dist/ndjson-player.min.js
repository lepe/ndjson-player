...
class NdJsonPlayer{fps;loop;showfirst;autoplay;path;playing=!1;loaded=!1;backwards=!1;started=!1;onStart;onLoad;onRender;onFinish;onError;player=null;canvas=null;ctx=null;timer=null;src="";frame=0;multiplier=1;_numFrames=0;_totTime=0;_frames=[];_frameBase="";constructor(t,e,s,a,i,r,n,o){const h=this;h.src=t,window.requestAnimationFrame||(window.requestAnimationFrame=window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame),h.onStart=a||function(){},h.onLoad=i||function(){},h.onRender=r||function(){},h.onFinish=n||function(){},h.onError=o||function(t){console.log(t)};let c=null;if(e instanceof Node)c=e;else{if("object"==typeof e)s=e,e="canvas";else if("string"!=typeof e)throw"Incorrect parameter passed to constructor of NdJsonPlayer";c=document.querySelector(e||"canvas")}if(!c)throw"Canvas element was not found in DOM: "+e;if("CANVAS"===c.tagName){h.canvas=c;const t=document.createElement("div");c.parentNode.insertBefore(t,c),t.prepend(c),c=t}else if(c.hasChildNodes()){if(h.canvas=c.querySelector("canvas"),!h.canvas)throw"No canvas found in element"}else h.canvas=document.createElement("CANVAS"),c.prepend(h.canvas);h.player=c,h.canvas.height=h.canvas.clientHeight,h.canvas.width=h.canvas.clientWidth,c.classList.add("ndjp"),h.ctx=h.canvas.getContext("2d"),h.fps=s.fps||24,h.loop=s.loop||!1,h.autoplay=s.autoplay||!1,h.showfirst=!1!==s.showfirst,h.path=s.path||"",h.timer=new TimerSrc(1e3/h.fps),h.load((function(t){void 0!==t.w&&(h.canvas.width=t.w),void 0!==t.h&&(h.canvas.height=t.h),void 0!==t.fb&&(h._frameBase=t.fb),void 0!==t.tf&&(h._numFrames=t.tf),void 0!==t.tt&&(h._totTime=t.tt),void 0!==t.fps&&(h.fps=t.fps,h.timer=new TimerSrc(1e3/h.fps)),void 0!==t.f?(h._frames.push(t),h.loaded||(h.loaded=!0,h.autoplay?h.play():h.showfirst&&h.step())):h.onRender(t),h.started||(h.onStart(h),h.started=!0)}))}load(t,e){const s=this;void 0!==e&&(this.src=e,this._frames=[]);const a=new TextDecoder;let i="";return fetch(s.src).then(t=>t.body.getReader()).then(e=>e.read().then((function r({value:n,done:o}){if(o)return t(JSON.parse(i)),void s.onLoad(s);const h=(i+a.decode(n,{stream:!0})).split(/[\r\n](?=.)/);return i=h.pop(),h.map(JSON.parse).forEach(t),e.read().then(r)}))).catch(t=>this.onError(t))}_render(t){if(null==this.timer)throw"TimerSrc was not initialized";if(0===this._frames.length)throw"Video is empty or no frames were found";this.frame>=this._frames.length&&(this.frame=this.loop?0:this._frames.length-1),this.frame<0&&(this.frame=this.loop?this._frames.length-1:0),this._displayImg(t)}_displayImg(t){const e=this,s=e._frames[e.frame],a=function(){e.onRender(s),e.timer.call((function(){t||(e._increment(),e.timer.nocall()),e._displayImg()}))};if(void 0!==s.f){const t=e._frameBase+s.f;e._image(t,a)}else e.onRender(s),a()}_increment(){this.frame+=this.multiplier*(this.backwards?-1:1),this.frame<0&&(this.loop?this.frame=this._frames.length-1:(this.frame=0,this.pause(),this.onFinish(this))),this.frame>this._frames.length-1&&(this.loop?this.frame=0:(this.frame=this._frames.length-1,this.pause(),this.onFinish(this)))}_draw=function(t,e){const s=this;return 0===t.width&&0===t.height?(t.onerror(),void 0!==e&&e(!1)):(s.ctx.save(),s.ctx.drawImage(t,0,0,t.width,t.height,0,0,s.canvas.width,s.canvas.height),s.ctx.restore(),void 0!==e&&e(!0)),this};_image=function(t,e){const s=this,a=new Image;return a.crossOrigin="",a.onload=function(){s._draw(a,(function(t){t&&void 0!==e&&e(a)}))},a.onerror=function(){const t=s.onError();t&&(a.src=t)},a.src="/"===t[0]||t.match(/^https?:/)||t.match(/^data:image/)?t:s.path+t,this};frameBase(){return this._frameBase}currentFrame(){return this.frame}totalFrames(){return this._numFrames||this._frames.length}totalTime(){return this._totTime||this.currentFrame()/this.fps}frameAt(t){const e=this;let s=t<this.totalFrames()?e._frames[t]:null;return s&&(s.fb=e._frameBase),s}indexAt(t){return~~(t*this.totalFrames()/100)}playerNode(){return this.player}play(t){t<0?t=0:t>this._frames.length?t=this._frames.length-1:void 0!==t&&(this.frame=1*t),this.playing=!0,this.timer.play(),this._render(!1)}playForward(t){this.backwards=!1,this.play(t)}playBackwards(t){this.backwards=!0,this.play(t)}pause(){this.playing=!1,this.timer.pause()}stop(){this.playing=!1,this.frame=0,this.timer.pause(),this._displayImg(!0)}step(t){t<0?t=0:t>this._frames.length?t=this._frames.length-1:void 0!==t&&(this.frame=1*t),this.playing=!1,this.timer.step(),this._render(!0)}stepForwards(){this.backwards=!1,this.step()}stepBackwards(){this.backwards=!0,this.step()}reset(){return void 0!==this.ctx.reset&&(this.ctx.reset(),this.ctx.clear(),this.stop(),this.canvas.width=this.canvas.width),this}}
class NDJPlayer{ndjp;options;ui;onAction;constructor(t,s,e,n){const o=this;this.options=Object.assign({controls:!1,play:!0,stop:!1,step:!1,progress:!0,thumbs:!0,fullscreen:!1,speed:!1,lapse:!0,frames:!0,resize:!0},e||{}),this.onAction=n||function(){},this._create(s),this.ndjp=new NdJsonPlayer(t,s,e,(function(t){o._adjustSize(),void 0!==o.options.onstart&&o.options.onstart(t)}),(function(t){void 0!==o.options.onload&&o.options.onload(t)}),(function(t){o._onUpdate(t),void 0!==o.options.onrender&&o.options.onrender(t)}),(function(t){}),(function(t){}))}_onUpdate(t){const s=this;void 0!==s.ui.frames&&(s.ui.frames.text=s.ndjp.currentFrame()+1+"/"+s.ndjp.totalFrames()),void 0!==s.ui.lapse&&(s.ui.lapse.text=void 0!==t.t?t.t+(s.ndjp._totTime>0?"/"+s.ndjp.totalTime():""):s._fmtTime(s.ndjp.totalTime())),void 0!==s.ui.progress&&(s.ui.progress.value=(s.ndjp.currentFrame()+1)/s.ndjp.totalFrames()*100)}_adjustSize(){if(this.options.resize){let t=this.ndjp.player,s=this.ndjp.player.parentElement;if(t.clientHeight>s.clientHeight){let e=this.ndjp.canvas.height/this.ndjp.canvas.width,n=this.ndjp.canvas.width/this.ndjp.canvas.height;this.ndjp.canvas.height=s.clientHeight-(this.options.controls?t.querySelector(".controls").clientHeight:0),this.ndjp.canvas.width=s.clientWidth*(e<1?e:n)}}}_create(t){this.ui=m2d2(t,Object.assign(this._getUI(t),{thumb:{show:!1,img:{src:""},caption:""}}))}_fmtTime(t){let s=(t=t.toFixed(2)).split(".")[1]||"00";return(~~(t/60)+"").padStart(2,"0")+":"+(~~(t/60%1*60)+"").padStart(2,"0")+"."+s}_getUI(t){const s=this;let e={html:t.innerHTML||""};const n={play:{show:s.options.play,title:"Play",text:"▶️",href:"#",onclick:function(){return s.onAction("play",s.ndjp,s),s.ndjp.play(),s.ui.play.show=!1,s.ui.pause.show=!0,!1}}},o={pause:{show:s.options.pause,title:"Pause",text:"⏸️",href:"#",onclick:function(){return s.onAction("pause",s.ndjp,s),s.ndjp.pause(),s.ui.play.show=!0,s.ui.pause.show=!1,!1}}},i={stop:{title:"Stop",text:"⏹️",href:"#",onclick:function(){return s.onAction("stop",s.ndjp,s),s.ndjp.stop(),!1}}},a={lapse:{show:s.options.lapse,title:"Time elapsed / Time Total",text:"0:00"}},l={frames:{show:s.options.frames,title:"Current Frame / Total Frames",text:"0"}},c={progress:{show:s.options.progress,value:0,max:100,onmousemove:function(t){let e=~~(t.offsetX/this.offsetWidth*100),n=s.ndjp.frameAt(s.ndjp.indexAt(e));if(n){s.ui.thumb.show=!0,s.ui.thumb.img.src=s.ndjp.frameBase()+(n.th||n.f),void 0!==n.tc&&(s.ui.thumb.caption=n.tc);let e=s.ui.thumb._node;e.style.left=this.offsetLeft+t.offsetX-e.clientWidth/2+"px"}else s.ui.thumb.show=!1},onmouseleave:function(){s.ui.thumb.show=!1},onclick:function(t){let e=~~(t.offsetX/this.offsetWidth*100),n=s.ndjp.indexAt(e);s.ndjp.step(n),s.onAction("progress",s.ndjp,s)}}};switch(this.options.controls){case"basic":case!0:e.html=this._getBasicUI(),e=Object.assign(e,n,o,a,c);break;case"common":e.html=this._getCommonUI(),e=Object.assign(e,n,o,a,c,l);break;case"full":e.html=this._getFullUI(),e=Object.assign(e,n,o,a,c,l,i)}this.options.controls;let p=t instanceof Node?t:document.querySelector(t);if(p){p.querySelector("canvas")||(e.html="<canvas></canvas>"+e.html)}else console.log("Root element: "+t+" was not found in document"),e.html="<canvas></canvas>"+e.html;return e}_getBasicUI(){return'<caption></caption>\n<div class="controls">\n<a class="play"></a>\n<a class="pause"></a>\n<label class="lapse"></label>\n<figure class="thumb"><img /><figcaption class="caption"></figcaption></figure>\n<progress></progress>\n</div>'}_getCommonUI(){return'<caption></caption>\n<div class="controls">\n<a class="play"></a>\n<a class="pause"></a>\n<label class="lapse"></label>\n<progress></progress>\n<label class="frames"></label>\n<figure class="thumb"><img /><figcaption class="caption"></figcaption></figure>\n</div>'}_getFullUI(){return'<caption></caption>\n<div class="controls">\n<a class="play"></a>\n<a class="pause"></a>\n<a class="stop"></a>\n<label class="lapse"></label>\n<progress></progress>\n<label class="frames"></label>\n<figure class="thumb"><img /><figcaption class="caption"></figcaption></figure>\n</div>'}}
class VideoND extends HTMLElement{constructor(){super();const t={autoplay:!1,controls:!1,loop:!1,width:"auto",height:"auto",poster:"",preload:"auto",src:"",cc:"auto",caption:"",fullscreen:!1,fps:"",speed:!1,autosize:"auto",sizes:{}||[],thumbs:"auto"},o={};for(let n in t)o[n]=this.getAttribute(n)||this.hasAttribute(n)||t[n];o.onstart=function(t){void 0!==n.onstart&&n.onstart(t)},o.onload=function(t){void 0!==n.onload&&n.onload(t)},o.onrender=function(t){void 0!==n.onrender&&n.onrender(t,e.ndjp,e,e.ndjp.canvas,e.ndjp.ctx)},this.style.display="block",this.className="ndjp",this._root=this;const n=this,e=new NDJPlayer(o.src,this,o,(function(t,o,e){void 0!==n.onaction&&n.onaction(t,o,e)}))}setCaption(t){this._root.querySelector("caption").innerText=t}static get observedAttributes(){return["width","height","caption"]}attributeChangedCallback(t,o,n){"caption"===t&&this.setCaption(n)}}document.addEventListener("DOMContentLoaded",(function(){window.customElements.define("video-nd",VideoND)}));