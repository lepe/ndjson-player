...
class NDJPlayer{ndjp;options;ui;onAction;constructor(t,o,s,n){const e=this;this.options=Object.assign({controls:!1,resize:!0},s||{}),this.onAction=n||function(){},this._create(o),this.ndjp=new NdJsonPlayer(t,o,s,(function(t){e._adjustSize(),void 0!==e.options.onstart&&e.options.onstart(t)}),(function(t){void 0!==e.options.onload&&e.options.onload(t)}),(function(t){e._onUpdate(t),void 0!==e.options.onrender&&e.options.onrender(t)}),(function(t){}),(function(t){}))}_onUpdate(t){const o=this;if(void 0!==o.ui&&void 0!==o.ui.controls){if(void 0!==o.ui.controls.frames&&(o.ui.controls.frames.text=o.ndjp.currentFrame()+1+"/"+o.ndjp.totalFrames()),void 0!==o.ui.controls.lapse){let s="";const n=o.ndjp._startTimeStamp&&void 0!==t.ts,e=void 0!==t.t,i=o.ndjp._totTime>0;t.d&&(s=t.d+" "),n?s+=o._formatMillis(t.ts-o.ndjp._startTimeStamp):e&&(s+=t.t.indexOf(":")>0?t.t:o._fmtTime(t.t)),i&&(s+="/"+o.ndjp.totalTime()),o.ui.controls.lapse.text=s}void 0!==o.ui.controls.progress&&(o.ui.controls.progress.value=(o.ndjp.currentFrame()+1)/o.ndjp.totalFrames()*100)}}_adjustSize(){if(this.options.resize){let t=this.ndjp.player,o=this.ndjp.player.parentElement;if(t.clientHeight>o.clientHeight){let s=this.ndjp.canvas.height/this.ndjp.canvas.width,n=1/s;this.ndjp.canvas.height=o.clientHeight-(this.options.controls?t.querySelector(".controls").clientHeight:0),this.ndjp.canvas.width=o.clientWidth*(s<1?s:n)}}}_create(t){this.ui=m2d2(t,this._getUI(t))}_getUI(t){const o=this;let s={html:t.innerHTML||""};const n={tagName:"a",className:"play",show:!0,title:"Play",text:"▶️",href:"#",onclick:function(){return o.onAction("play",o.ndjp,o),o.ndjp.play(),o.ui.controls.play.show=!1,o.ui.controls.pause.show=!0,!1}},e={tagName:"a",className:"pause",show:!1,title:"Pause",text:"⏸️",href:"#",onclick:function(){return o.onAction("pause",o.ndjp,o),o.ndjp.pause(),o.ui.controls.play.show=!0,o.ui.controls.pause.show=!1,!1}},i={tagName:"a",className:"stop",title:"Stop",text:"⏹️",href:"#",onclick:function(){return o.onAction("stop",o.ndjp,o),o.ndjp.stop(),!1}},a={tagName:"label",className:"lapse",show:!0,title:"Time elapsed / Time Total",text:"0:00"},l={tagName:"label",className:"frames",show:!0,title:"Current Frame / Total Frames",text:"0"},c={show:!0,value:0,max:100,onmousemove:function(t){let s=~~(t.offsetX/this.offsetWidth*100),n=o.ndjp.frameAt(o.ndjp.indexAt(s));if(n){o.ui.controls.thumb.show=!0,o.ui.controls.thumb.img.src=o.ndjp.frameBase()+(n.th||n.f),void 0!==n.tc&&(o.ui.controls.thumb.caption=n.tc);let s=o.ui.controls.thumb._node;s.style.left=this.offsetLeft+t.offsetX-s.clientWidth/2+"px"}else o.ui.controls.thumb.show=!1},onmouseleave:function(){o.ui.controls.thumb.show=!1},onclick:function(t){let s=~~(t.offsetX/this.offsetWidth*100),n=o.ndjp.indexAt(s);o.ndjp.step(n),o.onAction("progress",o.ndjp,o)}};if(this.options.controls){const t="full"===this.options.controls,o="common"===this.options.controls;s=this._getBasicUI(),s.controls.play=n,s.controls.pause=e,t&&(s.controls.stop=i),s.controls.lapse=a,s.controls.progress=c,(o||t)&&(s.controls.frames=l)}this.options.controls;let r=t instanceof Node?t:document.querySelector(t);if(r){r.querySelector("canvas")||(s=Object.assign({canvas:""},s))}else console.log("Root element: "+t+" was not found in document"),s=Object.assign({canvas:""},s);return s}_getBasicUI(){return{caption:"",controls:{tagName:"div",className:"controls",thumb:{tagName:"figure",className:"thumb",show:!1,img:{src:""},caption:{tagName:"figCaption",className:"caption",show:!1}}}}}_fmtTime(t){let o=(t=t.toFixed(2)).split(".")[1]||"00";return(~~(t/60)+"").padStart(2,"0")+":"+(~~(t/60%1*60)+"").padStart(2,"0")+"."+o}_formatMillis(t){function o(t,o){return("00"+t).slice(-1*(o||2))}const s=Math.floor(t/1e3/60/60),n=Math.floor(60*(t/1e3/60/60-s)),e=Math.floor(60*(60*(t/1e3/60/60-s)-n)),i=parseInt(t%1e3/100);return o(s)+":"+o(n)+":"+o(e)+"."+o(i,3)}}
