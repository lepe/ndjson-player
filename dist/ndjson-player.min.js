...
class NdJsonPlayer{fps;loop;showfirst;autoplay;path;onRender;onFinish;onError;_player=null;_canvas=null;_ctx=null;_timer=null;_src="";_numFrames=0;_frames=[];_frame=0;_frameBase="";_loaded=!1;_playing=!1;_backwards=!1;_multiplier=1;constructor(e,t,s,a,r,i){const n=this;n._src=e,window.requestAnimationFrame||(window.requestAnimationFrame=window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame),n.onRender=a||function(){},n.onFinish=r||function(){},n.onError=i||function(e){console.log(e)};let o=null;if(t instanceof Node)o=t;else{if("object"==typeof t)s=t,t="canvas";else if("string"!=typeof t)throw"Incorrect parameter passed to constructor of NdJsonPlayer";o=document.querySelector(t||"canvas")}if(!o)throw"Canvas element was not found in DOM: "+t;if("CANVAS"===o.tagName){n._canvas=o;const e=document.createElement("div");o.parentNode.insertBefore(e,o),e.prepend(o),o=e}else if(o.hasChildNodes()){if(n._canvas=o.querySelector("canvas"),!n._canvas)throw"No canvas found in element"}else n._canvas=document.createElement("CANVAS"),o.prepend(n._canvas);n._player=o,n._canvas.height=n._canvas.clientHeight,n._canvas.width=n._canvas.clientWidth,o.classList.add("ndjp"),n._ctx=n._canvas.getContext("2d"),n.fps=s.fps||24,n.loop=s.loop||!1,n.autoplay=s.autoplay||!1,n.showfirst=!1!==s.showfirst,n.path=s.path||"",n._timer=new TimerSrc(1e3/n.fps),n.load((function(e){void 0!==e.fb&&(n._frameBase=e.fb),void 0!==e.tf&&(n._numFrames=e.tf),void 0!==e.fps&&(n.fps=e.fps,n._timer=new TimerSrc(1e3/n.fps)),void 0!==e.f&&(n._frames.push(e),n._loaded||(n._loaded=!0,n.autoplay?n.play():n.showfirst&&n.step()))}))}load(e,t){void 0!==t&&(this._src=t,this._frames=[]);const s=new TextDecoder;let a="";return fetch(this._src).then(e=>e.body.getReader()).then(t=>t.read().then((function r({value:i,done:n}){if(n)return void e(JSON.parse(a));const o=(a+s.decode(i,{stream:!0})).split(/[\r\n](?=.)/);return a=o.pop(),o.map(JSON.parse).forEach(e),t.read().then(r)}))).catch(e=>this.onError(e))}_render(e){if(null==this._timer)throw"TimerSrc was not initialized";if(0===this._frames.length)throw"Video is empty or no frames were found";this._frame>=this._frames.length&&(this._frame=this.loop?0:this._frames.length),this._frame<0&&(this._frame=this.loop?this._frames.length-1:0),this._displayImg(e)}_displayImg(e){const t=this,s=t._frames[t._frame],a=function(){t.onRender(s),t._timer.call((function(){e||(t._increment(),t._timer.nocall()),t._displayImg()}))};if(void 0!==s.f){const e=t._frameBase+s.f;t._image(e,a)}else t.onRender(s),a()}_increment(){this._frame+=this._multiplier*(this._backwards?-1:1),this._frame<0&&(this.loop?this._frame=this._frames.length-1:(this._frame=0,this.pause())),this._frame>this._frames.length-1&&(this.loop?this._frame=0:(this._frame=this._frames.length-1,this.pause()))}_draw=function(e,t){const s=this;return 0===e.width&&0===e.height?(e.onerror(),void 0!==t&&t(!1)):(s._ctx.save(),s._ctx.drawImage(e,0,0,e.width,e.height,0,0,s._canvas.width,s._canvas.height),s._ctx.restore(),void 0!==t&&t(!0)),this};_image=function(e,t){const s=this,a=new Image;return a.crossOrigin="",a.onload=function(){s._draw(a,(function(e){e&&void 0!==t&&t(a)}))},a.onerror=function(){const e=s.onError();e&&(a.src=e)},a.src="/"===e[0]||e.match(/^https?:/)||e.match(/^data:image/)?e:s.path+e,this};frameBase(){return this._frameBase}currentFrame(){return this._frame}totalFrames(){return this._numFrames||this._frames.length}frameAt(e){const t=this;let s=e<this.totalFrames()?t._frames[e]:null;return s&&(s.fb=t._frameBase),s}indexAt(e){return~~(e*this.totalFrames()/100)}playerNode(){return this._player}play(e){e<0?e=0:e>this._frames.length?e=this._frames.length-1:void 0!==e&&(this._frame=1*e),this._playing=!0,this._timer.play(),this._render(!1)}playForward(e){this._backwards=!1,this.play(e)}playBackwards(e){this._backwards=!0,this.play(e)}pause(){this._playing=!1,this._timer.pause()}stop(){this._playing=!1,this._frame=0,this._timer.pause(),this._displayImg(!0)}step(e){e<0?e=0:e>this._frames.length?e=this._frames.length-1:void 0!==e&&(this._frame=1*e),this._playing=!1,this._timer.step(),this._render(!0)}stepForwards(){this._backwards=!1,this.step()}stepBackwards(){this._backwards=!0,this.step()}reset(){return void 0!==this._ctx.reset&&(this._ctx.reset(),this._ctx.clear(),this.stop(),this._canvas.width=this._canvas.width),this}}
